...
def add_ann_adj_info(extra_tag):
    ...
    dataroot = '/mnt/allfile/project/SurroundOcc/data/nuscenes'
    nuscenes = NuScenes(nuscenes_version, dataroot)
    for set in ['train', 'val']:
        dataset = pickle.load(
            open('/mnt/allfile/project/SurroundOcc/data/nuscenes/%s_infos_%s.pkl' % (extra_tag, set), 'rb'))
        for id in range(len(dataset['infos'])):
            ...
            dataset['infos'][id]['occ_path'] = \
                '/mnt/allfile/project/SurroundOcc/data/nuscenes/gts/%s/%s'%(scene['name'], info['token'])
        with open('/mnt/allfile/project/SurroundOcc/data/nuscenes/%s_infos_%s.pkl' % (extra_tag, set),
                  'wb') as fid:
...
if __name__ == '__main__':
    ...
    root_path = '/mnt/allfile/project/SurroundOcc/data/nuscenes'
