...
def parse_args():
    ...
    parser.add_argument('--config',default='./configs/renderocc/renderocc-7frame.py', help='test config file path')
    parser.add_argument('--checkpoint',default='./ckpts/renderocc-7frame-12e.pth' ,help='checkpoint file')
    ...
    parser.add_argument(
        '--show-dir', default='./result',help='directory where results will be saved')
    parser.add_argument(
        '--gpu-collect',
        action='store_true',
