...
data_root = '/mnt/allfile/project/SurroundOcc/data/nuscenes'
    ...
    for i, cam_key in enumerate(cam_keys):
        ...
        np.concatenate([pts_img[:2, :].T, depth[:, None]],
                       axis=1).astype(np.float32).flatten().tofile(
                           os.path.join('/mnt/allfile/project/SurroundOcc/data/nuscenes', 'depth_gt',
                                        f'{file_name}.bin'))

if __name__ == '__main__':
    po = Pool(12)
    mmcv.mkdir_or_exist(os.path.join('/mnt/allfile/project/SurroundOcc/data/nuscenes', 'depth_gt'))
