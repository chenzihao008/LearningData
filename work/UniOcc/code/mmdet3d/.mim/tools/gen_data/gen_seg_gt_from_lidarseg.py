...
save_folder = os.path.join('/mnt/allfile/project/SurroundOcc/data/nuscenes/', 'seg_gt_lidarseg') 
info_path_train = '/mnt/allfile/project/SurroundOcc/data/nuscenes/bevdetv2-nuscenes_infos_train.pkl'
info_path_val = '/mnt/allfile/project/SurroundOcc/data/nuscenes/bevdetv2-nuscenes_infos_val.pkl'
...
nusc = NuScenes(version='v1.0-trainval', dataroot='/mnt/allfile/project/SurroundOcc/data/nuscenes', verbose=True)
...
def worker(info):
    ...
    for i, cam_key in enumerate(cam_keys):
        ...
        if visual:
            mmcv.mkdir_or_exist(os.path.join('/mnt/allfile/project/SurroundOcc/data', 'seg_gt_visual'))
            png_name = os.path.join('/mnt/allfile/project/SurroundOcc/data', 'seg_gt_visual', file_name)
